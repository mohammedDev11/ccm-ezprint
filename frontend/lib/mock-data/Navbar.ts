    ...
    items: [
      {
        ...
        icon: RiDashboardFill,
        href: "/sections/user/dashboard",
        lightVideoSrc: "/videos/user/Dashboard-Light.mp4",
        darkVideoSrc: "/videos/user/Dashboard-Dark.mp4",
      },
      {
        label: "Print",
        icon: RiUploadCloud2Line,
        href: "/sections/user/print",
        lightVideoSrc: "/videos/user/Print-Light.mp4",
        darkVideoSrc: "/videos/user/Print-Dark.mp4",
      },
      {
        label: "Recent Print Jobs",
        icon: RiFileList2Line,
        href: "/sections/user/recent-print-jobs",
        lightVideoSrc: "/videos/user/RecentPrintJob-Light.mp4",
        darkVideoSrc: "/videos/user/RecentPrintJob-Dark.mp4",
      },
      {
        label: "Pending Jobs",
        icon: TbChecklist,
        href: "/sections/user/pending-jobs",
        lightVideoSrc: "/videos/user/PendingJobs-Light.mp4",
        darkVideoSrc: "/videos/user/PendingJobs-Dark.mp4",
      },
      {
        label: "History",
        icon: RiHistoryLine,
        href: "/sections/user/history",
        lightVideoSrc: "/videos/user/History-Light.mp4",
        darkVideoSrc: "/videos/user/History-Dark.mp4",
      },
      {
        label: "Redeem",
        icon: MdOutlinePayments,
        href: "/sections/user/redeem",
        lightVideoSrc: "/videos/user/Redeem-Light.mp4",
        darkVideoSrc: "/videos/user/Redeem-Dark.mp4",
      },
      {
        label: "Profile",
        icon: HiOutlineUserCircle,
        href: "/sections/user/profile",
        lightVideoSrc: "/videos/user/Profile-Light.mp4",
        darkVideoSrc: "/videos/user/Profile-Dark.mp4",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: RiNotification3Line,
        href: "/sections/user/notifications",
        lightVideoSrc: "/videos/user/Notifications-Light.mp4",
        darkVideoSrc: "/videos/user/Notifications-Dark.mp4",
      },
      {
        label: "Settings",
        icon: RiSettings3Line,
        href: "/sections/user/settings",
        lightVideoSrc: "/videos/user/Settings-Light.mp4",
        darkVideoSrc: "/videos/user/Settings-Dark.mp4",
      },
      {
        label: "Main Page",
        icon: RiLogoutBoxRLine,
